				...
				<div id="content2">
					<div class="content"> 
					    ...
					    <div id="shopping_cart">
						   ...
						   <span style="float:right; font-size:18px; padding: 5px; line-height= 40px;">Welcome Guest!  <b style="color: #630460">Shopping Cart: </b> Total Items: Total Price: <a href="cart.php" style="color: #630460;">Go to Cart</a></span>
					    ...
					    if(isset($_GET['search'])){
					    	...
					    	$search_query = $_GET['user_query'];//stores user input when they search for products

					    	$get_pro = "select * from products where product_keywords like '%$search_query%'";//select statment that runs the query from product keyword field
