...
<?php 
		...
		while($p_price=mysqli_fetch_array($run_price)){
			...
			if($qty==0){ //gets the quantitiy and adds to it when $qty=1
		...
		echo "<a href='http://phpe.celestenunez.com/customer/my_account.php'>Go to your Account</a>";
		
		}//catches a fake credit card
		else {
		
		echo "<h2>Welcome Guest, Payment was failed</h2><br>";
		echo "<a href='http://phpe.celestenunez.com'>Go to Back to shop</a>";
			...
			$headers .= 'From: <ecncommunication@gmail.com>' . "\r\n";
			...
			Hello dear <b style='color:blue;'>$c_name</b> you have ordered some products on our website onlinetuting.com, please find your order details, your order will be processed shortly. Thank you!</p>
				...
				<h2> <a href='http://phpe.celestenunez.com/customer/my_account.php'>Click here</a> to login to your account</h2>
				
				<h3> Thank you for your order @ - http://phpe.celestenunez.com</h3>
