...
//script that detects user ip address
function getIp() {
...
function getPro(){
	...
	$get_pro = "select * from products LIMIT 0,4";
	...
	while ($row_pro = mysqli_fetch_array($run_pro)){
		...
		<div id = 'single_product'>
			...
			<img src='admin_area/product_images/$pro_image' width='220' height='240' />
	...
	$run_pro1=mysqli_query($con, $get_pro);
	...
	$a = ceil($a);
		...
		for($b=1;$b<=$a;$b++)
		{
			?><a href="all_products.php"><?php echo $b." "; ?></a><?php
		}
	}
}
}
